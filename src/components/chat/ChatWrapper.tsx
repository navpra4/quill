...
const ChatWrapper = ({fileId}: ChatWrapperProps) => {
  ...
  const { data, isLoading , isSuccess} =
    trpc.getFileUploadStatus.useQuery(
      ...
      { 
        refetchInterval: status === 'SUCCESS' || status === 'FAILED' ? false : 500
      },
  ...
  return (
    ...
    <div className=" relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 gap-2 flex-col justify-between">
